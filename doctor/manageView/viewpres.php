...
if(isset($_POST['search'])) {
    $search = $_POST['search'];
    $stmt = $mysqli->prepare("SELECT * FROM tbl_checkup INNER JOIN tbl_prescription ON tbl_prescription.c_id = tbl_checkup.c_id WHERE presc_id LIKE '%$search%' OR tbl_prescription.c_id LIKE '%$search%'"); 
} else {
